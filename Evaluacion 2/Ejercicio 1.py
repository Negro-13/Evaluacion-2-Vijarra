...
primef = open('./Downloads/dlXPrimes.txt','w')
primef.write('numeros primos')
primef.write(str(primo))
primef.close()

noprimef = open('./Downloads/dlXNotPrimes.txt','w')
noprimef.write('numeros no primos')
noprimef.write(str(noprimo))
noprimef.close()
